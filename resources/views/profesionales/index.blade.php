...
<div class="page-header">
  <ol class="breadcrumb">
	...
	<li class="active"><i class="glyphicon glyphicon-certificate"></i> Profesionales</li>
  </ol>
  <h3>
  	Personal Militar Profesional <small>/ lista de registros</small>
  	<span class="pull-right">
  		<a href="{{ route('profesionales.create') }}" type="button" class="btn btn-primary">
...
<table id="TablaProfesionales" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
	<thead>
		<tr>
			<th>Cedula</th>
			<th>Nombre</th>
	...
	<tbody>
		...
		<tr>
			<td style="text-align: right;"><a href="{{ route('profesionales.show', $_personal->cedula) }}" title="Ver toda la informacion">{{ $_personal->cedula }}</a></td>
