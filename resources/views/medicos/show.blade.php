...
<div class="page-header">
  ...
  <h3>Personal Medico <small>/ ver informacion</small></h3>
</div>
  ...
  <div id="informacion" class="tab-pane active">
    ...
    <form class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <p class="form-control-static">{{ $medico->matricula }}</p>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10">
          <p class="form-control-static">{{ $especialidad_medica->nombre }}</p>
        </div>
      </div>

      <div class="form-group">
        <label class="col-lg-2 control-label">Consultorio</label>
        <div class="col-lg-10">
          <p class="form-control-static"><a href="{{ route('consultorios.show', $consultorio->codigo) }}">{{ $consultorio->nombre }}</a></p>
        </div>
      </div>
    </form>
  </div>
...
<div class="col-sm-6">
  <strong>Creado el</strong>: {{ $medico->created_at->format('d/m/Y') }} / <strong>Ultima actualizacion:</strong> {{ $medico->updated_at->format('d/m/Y h:i:s A') }}
</div>

<div class="col-sm-6">
  <div class="pull-right">
    <a href="{{ route('medicos.index') }}" type="button" class="btn btn-default"><span class="glyphicon glyphicon-circle-arrow-left" aria-hidden="true"></span> Atras</a>
    ...
    <a href="{{ route('medicos.edit', $personal->cedula) }}" type="button" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Actualizar</a>
  </div>
</div>
@stop
