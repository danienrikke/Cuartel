...
<div class="page-header">
  <ol class="breadcrumb">
	...
	<li class="active"><i class="glyphicon glyphicon-user"></i> Obreros</li>
  </ol>
  <h3>
  	Personal Civil Obrero <small>/ lista de registros</small>
  	<span class="pull-right">
  		<a href="{{ route('obreros.create') }}" type="button" class="btn btn-primary">
...
<table id="TablaObreros" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
	<thead>
		<tr>
			<th>Cedula</th>
			<th>Nombre</th>
	...
	<tbody>
		...
		<tr>
			<td style="text-align: right;"><a href="{{ route('obreros.show', $_personal->cedula) }}" title="Ver toda la informacion">{{ $_personal->cedula }}</a></td>
